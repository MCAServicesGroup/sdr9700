...
- Pressuring contributors to bypass licensing, attribution, safety, or review
  requirements.

## Reporting

Report conduct issues privately to the repository owner or maintainer. Include
links, screenshots, or other context when possible.

Maintainers may remove comments, close discussions, block users, or take other
reasonable action to protect the project.
